        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="nombre">Organismo</label><span class="ms-1 text-danger fs-6 fw-semibold">*</span>
                ...
                <div class="form-group">
                    <label for="sigla">Sigla</label><span class="ms-1 text-danger fs-6 fw-semibold">*</span>
                    <input type="text" class="form-control" id="sigla" wire:model="sigla">
                    @error('sigla')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
